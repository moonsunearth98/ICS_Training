create database practice_normalization

use practice_normalization
...
create table Rentals_2nf(
    c_number VARCHAR(255)REFERENCES Clients_2nf(c_number),
    propertyNo VARCHAR(255) REFERENCES Properties_2nf(propertyNo),
    rent_start DATE,
    rent_finish DATE,
    rent INT,
...
create table properties_3nf (
    propertyNo varchar(255) primary key,
    p_address varchar(255),
    owner_no varchar(255) references p_owners_3nf(owner_no)
)
